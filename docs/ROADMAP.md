...
2. **Milestone 1.1 — Fully self-hosted Vilnius basemap (draft PR).** The local pipeline and style are
   ...
   browser smoke test, and zoom-aware transportation tiles are implemented. Final acceptance still
   requires the documented disconnected laptop/browser and physical-iPhone visual checks.
